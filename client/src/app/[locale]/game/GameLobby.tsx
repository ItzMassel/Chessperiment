        ...
        <div className="max-w-5xl w-full grid grid-cols-1 lg:grid-cols-2 gap-8 p-6 animate-in fade-in slide-in-from-bottom-12 duration-1000">
            ...
            <div className="flex flex-col gap-8">
                ...
                >
                    ...
                    <div className="relative z-10 text-left flex items-center justify-between">
                        <div>
                            <div className="w-16 h-16 bg-emerald-500/10 rounded-2xl flex items-center justify-center mb-6 text-emerald-500 border border-emerald-500/20 shadow-lg">
                                <UserRound size={32} />
                            </div>
                            <h3 className="text-2xl font-black text-stone-900 dark:text-white uppercase tracking-tight mb-2">Local 2P</h3>
                            <p className="text-stone-500 dark:text-stone-400 text-lg">Play hotseat on this device</p>
                        </div>
                        <UserRound className="text-stone-300 dark:text-stone-700 group-hover:text-emerald-500 transition-all duration-500" size={56} strokeWidth={3} />
                    </div>
                </button>
            </div>
